...
<head>
    ...
    <style type = "text/css">
        ...
        /* .bg-img {background-color: url(https://mindbodygreen-res.cloudinary.com/images/w_767,q_auto:eco,f_auto,fl_lossy/org/viq2u2mlzk5ib9k92/11-types-of-yoga-a-breakdown-of-each-style.jpg); height: 100%; background-size: cover; position: relative;} */
...
<body style = "background-color: #f0ede4">
        <div class = "card">
            <form name = "CM" action = "" method = "post">
                <div class = "row">
                    <div class = "col-25">
                        <label for = "ManagerName"><b>MANAGER NAME</b> </label>
                    </div>  
                    <div class = "col-75">  
                        <input type = "text" name = "ManagerName" placeholder = "Enter Name">
                    </div>
                </div>        
                ...
                <div class = "row">
                    ...
                    <div class = "col-75">
                        <input type="tel" id="Contact" name="Contact" placeholder = "Enter Contact">
                    </div>
                </div>
                <br><br>
        ...
        if(isset($_POST['insert']))
        {
            ...
            $query = "INSERT INTO centermanager (ManagerID, ManagerName, Area, Contact) VALUES ('$ManagerID','$ManagerName', '$Area', '$Contact')";
