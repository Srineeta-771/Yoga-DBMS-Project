...
<head>
    <title></title>
    <style type = "text/css">
        input[type=text], input[type=tel], input[type=date], select, textarea{ width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; resize: vertical; }
...
<body style = "background-color: #f0ede4">
        <div class = "card">
            <form name = "Trainee" action = "" method = "post">
                <div class = "row">
                    <div class = "col-25">
        ...
        if(isset($_POST['insert']))
        {
            ...
            $query = "INSERT INTO trainee (fname, lname, dob, addr, phno, yogatype, area) VALUES ('$fname', '$lname', '$dob', '$addr','$phno', '$yogatype', '$area')";
