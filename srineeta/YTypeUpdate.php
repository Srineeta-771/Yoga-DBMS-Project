...
<head>
    ...
    <style>
        .card { height: 45%; width: 45%; background-color: white; box-shadow: 0 8px 16px 0 #302D1F; padding: 50px 10px 50px 0; text-align: center; position: relative; top: 25%; left: 25%;}  
...
<body style = "background-color: #f0ede4;">
    ...
    $query = "SELECT * FROM ytype WHERE YogaType='$YogaType' ";
            ...
            <div class="card">
                <!-- <div class="jumbotron">
                        ...
                        <div class="col-md-12"> -->
                            ...
                            <form action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class = "col-75"> 
                                        <input type="text" name="Fees" value="<?php echo $row['Fees'] ?>" placeholder="Enter Fees" required>
                                    </div>
                                </div>
                                <br><br>
                                
                                <button type="submit" name="update" class="btn3"> Update Data </button>
                                <a href="YTypeIndex.php" class="btn2"> CANCEL </a>
                            </form>
                    ...
                    if(isset($_POST['update']))
                    {
                        ...
                        $query = "UPDATE ytype SET  YogaType='$YogaType', Duration = '$Duration', Fees='$Fees'  WHERE YogaType='$YogaType' ";
                        $query_run = mysqli_query($connection, $query);
